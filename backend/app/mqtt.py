...
class MQTT:
    ...
    sub_topics = [("620171712_pub", 0), ("620171712", 0), ("620171712_sub", 0)] #  A list of tuples of (topic, qos). Both topic and qos must be present in the tuple.
    ...
    def __init__(self,mongo):
        ...
        self.client.message_callback_add("620171712", self.update)
